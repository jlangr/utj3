...
class ACriteria {
    Criterion criterion1 = new Criterion(new BooleanQuestion(1, "?"), true);
    Criterion criterion2 = new Criterion(new BooleanQuestion(2, "?"), false);
    Criterion criterion3 = new Criterion(new BooleanQuestion(3, "?"), false);
